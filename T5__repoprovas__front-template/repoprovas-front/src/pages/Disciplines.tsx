      ...
      {categories
        ...
        .map((category) => (
          <Box key={category.id}>
            ...
            <TeachersDisciplines category={category} teachersDisciplines={teachersDisciplines} />
          </Box>
        ))}
    </>
  );
...
function TeachersDisciplines( { teachersDisciplines, category }: TeacherDisciplineProps) {
